...
"""
function newcurrency!(symb::Symbol, name::AbstractString, expt::Int64)
...
currencyinfo{T}(::Type{Monetary{T}}) = currencyinfo(T)
currencyinfo{T,U}(::Type{Monetary{T,U}}) = currencyinfo(T)
currencyinfo{T<:Monetary}(m::T) = currencyinfo(T)
